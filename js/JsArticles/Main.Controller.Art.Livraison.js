...
if (typeof localStorage["ngStorage-OID_PRD"] == 'undefined'){
alert("Veuillez choisir un article dans l'onglet Articles ! ");
window.location.href = "../EspaceArticles/Espace.Articles.html"
}
var oidPrd = localStorage.getItem("ngStorage-OID_PRD");

angular.module('Articles', ['angularCharts']);

function MainController($scope,$http) {

$http.get('http://132.148.133.254:8888/WebServiceCommercial/rest/services/getLivraisonArtMoisInJSON/' + oidOrg+ '/' + oidPrd)							
