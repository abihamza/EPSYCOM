var app = angular.module('app', ["ngStorage"]);
						...
						$http.get("http://132.148.133.254:8888/WebServiceCommercial/rest/services/getFournisseursInJSON")
							...
							angular.forEach($scope.empData, function(val){
								angular.forEach(val, function(cb, key) {
									if(key.substring(0, 2) == "cb" && cb ) {
										...
										$localStorage.OID_FRS = val.Commercial.oid; // sauvegarder la valeur du OID dans la memoire
										$localStorage.NOM_FRS =  val.Commercial.nomTier;
