...
var oidTier = localStorage.getItem("ngStorage-OID_CLT");

angular.module('Clients', ['angularCharts']);

function MainController($scope,$http) {

$http.get('http://132.148.133.254:8888/WebServiceCommercial/rest/services/getEncCltInJSON/' + oidOrg + '/' + oidTier)					
