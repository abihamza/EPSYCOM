var app = angular.module('app', ["ngStorage"]);
						...
						$http.get("http://132.148.133.254:8888/WebServiceCommercial/rest/services/getClientsInJSON")
							...
							angular.forEach($scope.empData, function(val){
								angular.forEach(val, function(cb, key) {
									if(key.substring(0, 2) == "cb" && cb ) {
										...
										$localStorage.OID_CLT = val.Commercial.oid; // sauvegarder la valeur du OID dans la memoire
										$localStorage.NOM_CLT =  val.Commercial.nomTier;
